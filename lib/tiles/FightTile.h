...
class FightTile : public Tile {
    public:
        FightTile(const string& boss, const vector<Item*> rewards);
        ~FightTile();
        void print();
        ...
        vector<Item*>& getRewards(){ return rewards; }
    private:
        string boss;
        vector<Item*> rewards;
        ...
        vector<string> winDialogueEliteBoss = {
            ...
            "You leave with more questions than you began with and a new passion to get out of this place as the " + boss + " leaves a " + (rewards)[0]->getName() + " and " + (rewards)[1]->getName() + " behind.",
            ...
            "The " + boss + " collapses into ash, leaving a " + (rewards)[0]->getName() + " and " + (rewards)[1]->getName() + " behind. \n \n"
            ...
            "The " + boss + " vanishes, leaving a " + (rewards)[0]->getName() + " and " + (rewards)[1]->getName() + " behind. \n \n"
        ...
        vector<string> winDialogueNormalBoss = { 
            ...
            "You leave confused and frustrated, but a sense of accomplishment lingers as the " + boss + " leaves a " + (rewards)[0]->getName() + " and " + (rewards)[1]->getName() + " behind \n",
            ...
            "The " + boss + " vanishes into smoke, leaving behind the " + (rewards)[0]->getName() + " and " + (rewards)[1]->getName() + " glowing faintly in the dim light. \n \n"
            ...
            "Without another word, the " + boss + " collapses, leaving the " + (rewards)[0]->getName() + " and " + (rewards)[1]->getName() + " behind. \n \n"
