...
void EliteBoss2::Burn(Player& target){
    cout << "The Anthocalypse Burned you! Damage dealt: " << damageEnemyMagic(target, 4) << endl;
}

void EliteBoss2::Inferno(Player& target){
    target.getStats().reduceHp(3); //true damage, applied regardless of guarding
    cout << "The Anthocalypse used Inferno! Damage dealt: " << damageEnemyMagic(target, 5) << endl;
