...
void Map::initialize(){
    ...
    mapOfTiles[0][5] = new FightTile("BasicBoss", Excalibur);
    ...
    mapOfTiles[1][3] = new FightTile("EliteBoss", BowOfHouYi);
    mapOfTiles[1][4] = new WeaponTile(Weapon("Staff", 0,0,1,1,0,0));
    mapOfTiles[1][5] = new PotionTile(Potion("Rare Potion", 30));
    mapOfTiles[1][6] = new FightTile("EliteBoss",Labrys);
    mapOfTiles[1][7] = new EmptyTile();

    mapOfTiles[2][0] = new FightTile("EliteBoss", LegendaryPotion);
    mapOfTiles[2][1] = new FightTile("BasicBoss", RegularPotion);
    ...
    mapOfTiles[2][7] = new FightTile("FinalBoss", Lance);
