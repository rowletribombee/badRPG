...
Map::Map(){
    ...
    mapOfTiles[0][0] = new FightTile("BasicBoss", {new Potion("Potion", 20)});
    ...
    mapOfTiles[0][5] = new FightTile("BasicBoss", {new Weapon("Plate Armour", 0,1,0,2,0,0)});
    ...
    mapOfTiles[1][3] = new FightTile("EliteBoss", {new Weapon("Iron Sword", 1, 1, 0, 0, 0, 0)});
    mapOfTiles[1][4] = new WeaponTile(Weapon("Staff", 0,0,1,1,0,0));
    mapOfTiles[1][5] = new PotionTile(Potion("Rare Potion", 30));
    mapOfTiles[1][6] = new FightTile("EliteBoss", {new Weapon("Iron Sword", 1, 1, 0, 0, 0, 0)});
    mapOfTiles[1][7] = new EmptyTile();

    mapOfTiles[2][0] = new FightTile("EliteBoss", {new Weapon("Iron Sword", 1, 1, 0, 0, 0, 0)});
    mapOfTiles[2][1] = new FightTile("BasicBoss", {new Weapon("Plate Armour", 0,1,0,2,0,0)});
    ...
    mapOfTiles[2][7] = new FightTile("FinalBoss", {new Weapon("Lance", 1, 0, 0, 0, 1, 0)});
    ...
    mapOfTiles[3][6] = new FightTile("EliteBoss", {new Weapon("Iron Sword", 1, 1, 0, 0, 0, 0)});
    mapOfTiles[3][7] = new EmptyTile();

    mapOfTiles[4][0] = new EmptyTile();
    mapOfTiles[4][1] = new PotionTile(Potion("Rare Potion", 30));
    mapOfTiles[4][2] = new FightTile("BasicBoss", {new Weapon("Staff", 0,0,1,1,0,0)});
    mapOfTiles[4][3] = new EmptyTile();
    mapOfTiles[4][4] = new FightTile("BasicBoss", {new Potion("Rare Potion", 30)});
    mapOfTiles[4][5] = new FightTile("BasicBoss", {new Weapon("Lance", 1, 0, 0, 0, 1, 0)});
    mapOfTiles[4][6] = new EmptyTile();
    mapOfTiles[4][7] = new EmptyTile();

    mapOfTiles[5][0] = new EmptyTile();
    mapOfTiles[5][1] = new EmptyTile();
    mapOfTiles[5][2] = new FightTile("EliteBoss", {new Weapon("Iron Sword", 1, 1, 0, 0, 0, 0)});
    ...
    mapOfTiles[6][1] = new FightTile("BasicBoss", {new Potion("Potion", 20)});
    mapOfTiles[6][2] = new EmptyTile();
    mapOfTiles[6][3] = new PotionTile(Potion("Potion", 20));
    mapOfTiles[6][4] = new FightTile("BasicBoss", {new Weapon("Lance", 1, 0, 0, 0, 1, 0)});
    mapOfTiles[6][5] = new WeaponTile(Weapon("Lance", 1, 0, 0, 0, 1, 0));
    mapOfTiles[6][6] = new EmptyTile();
    mapOfTiles[6][7] = new FightTile("BasicBoss", {new Weapon("Iron Sword", 1, 1, 0, 0, 0, 0)});

    mapOfTiles[7][0] = new SpawnTile();
    mapOfTiles[7][1] = new PotionTile(Potion("Potion", 20));
    mapOfTiles[7][2] = new EmptyTile();
    mapOfTiles[7][3] = new FightTile("BasicBoss", {new Weapon("Staff", 0,0,1,1,0,0)});
    mapOfTiles[7][4] = new EmptyTile();
    mapOfTiles[7][5] = new EmptyTile();
    mapOfTiles[7][6] = new FightTile("EliteBoss", {new Weapon("Iron Sword", 1, 1, 0, 0, 0, 0)});
